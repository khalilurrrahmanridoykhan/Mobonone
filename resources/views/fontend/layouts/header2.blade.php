            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item {{ Request::routeIs('fontend.home') ? 'active' : '' }}"><a class="nav-link" href="{{ route('fontend.home') }}">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="about.html">Faculty Assinment</a></li>
                    </ul>
                </div>
            </div>
        </nav>
