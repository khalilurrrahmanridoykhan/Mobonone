                    ...
                    @if (!empty($service))
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card border-0">
                                ...
                                <img src="{{ asset('uploads/services/thumb/small/'.$service->img) }}" class="card-img-top" alt="">
                                @else
                                <img src="{{ asset('no_image/no_image_small.png') }}" class="card-img-top" alt="">
                                @endif
                                <div class="card-body p-3">
                                    <h1 class="card-title mt-2"><a href="#">{{ $service->name }}</a></h1>
                                    <div class="content pt-2">
                                        <p class="card-text">{{ $service->short_desc }}</p>
                                    </div>
                                    <a href="{{ url('/service/detail/'.$service->services_id)}}" class="btn btn-primary mt-4">Details <i class="fa-solid fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        @endforeach
