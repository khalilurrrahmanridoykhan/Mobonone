...
@section('content')
    <div class="content-wrapper">
        <div class="row justify-content-center">
            <div class="col-md-11">
                <div class="card">
                    <div class="card-header">{{ __(' Section List') }}</div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <a name="" id="" class="btn btn-success"
                                        href="{{ route('admin.section.create') }}" role="button">Create</a>
                                </div>
                                <div class="col-md-8">
                                            ...
                                            @if (!empty($section))
                                                @foreach ($section as $sections)
                                                    <tr>
                                                        ...
                                                        <td>{{ $sections->Section_no }}</td>
                                                        <td>{{ date('d/m/Y', strtotime($sections->created_at)) }}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <a href="{{ route('admin.section.edit',$sections->sections_id ) }}"><img
                                                                        src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                        alt=""></a>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('admin.section.delete', $sections->sections_id) }}"><img
