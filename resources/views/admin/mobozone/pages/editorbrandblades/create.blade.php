        ...
        <div class="row justify-content-center">
            <div class="col-md-11">
                <form action="" method="post" name="createServiceFrom" id="createServiceFrom">
                    <div class="card">
                        <div class="card-header">{{ __('Brand Create') }}</div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    <br>
                                    <a name="" id="" class="btn btn-primary" href="{{ route('editor.brand.index') }}" role="button">Back</a>
                                </div>
        ...
        $("#createServiceFrom").submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = '{{ route("editor.brand.index") }}';
