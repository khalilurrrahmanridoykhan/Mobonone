                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <a name="" id="" class="btn btn-success"
                                        href="{{ route('admin.product.create') }}" role="button">Create</a>
                                </div>
                                <div class="col-md-8">
                                            ...
                                            @if (!empty($product))
                                                @foreach ($product as $products)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <a href="{{ route('admin.product.edit',$products->products_id ) }}"><img
                                                                        src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                        alt=""></a>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('admin.product.delete', $products->products_id) }}"><img
