                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <a name="" id="" class="btn btn-success"
                                        href="{{ route('admin.category.create') }}" role="button">Create</a>
                                </div>
                                <div class="col-md-8">
                                            ...
                                            @if (!empty($category))
                                                @foreach ($category as $categorys)
                                                    <tr>
                                                        <td>{{ $categorys->id }}</td>
                                                        <td>
                                                            @if (!empty($categorys->picture))
                                                            <img src="{{ asset('uploads/category/thumb/small/' . $categorys->picture) }}"
                                                            width="50" alt="">
                                                            @else
                                                        ...
                                                        <td>
                                                            <span>
                                                                <a href="{{ route('admin.category.edit',$categorys->id ) }}"><img
                                                                        src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                        alt=""></a>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('admin.category.delete', $categorys->id) }}"><img
