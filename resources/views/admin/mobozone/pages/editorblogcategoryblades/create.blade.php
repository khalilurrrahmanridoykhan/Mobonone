        ...
        <div class="row justify-content-center">
            <div class="col-md-11">
                <form action="" method="post" name="createServiceFrom" id="createServiceFrom">
                    <div class="card">
                        <div class="card-header">{{ __('Blog Category Create') }}</div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    <br>
                                    <a name="" id="" class="btn btn-primary" href="{{ route('editor.blogcategory.index') }}" role="button">Back</a>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="">blogCategory Name</label>
...
@section('extraJs')
    <script type="text/javascript">
        ...
        $("#createServiceFrom").submit(function(event) {
            ...
            $.ajax({
                url: '{{ route("editor.blogcategory.save") }}',
                type: 'POST',
                dataType: 'json',
                ...
                success: function(response) {
                    ...
                    window.location.href = '{{ route("editor.blogcategory.index") }}';
