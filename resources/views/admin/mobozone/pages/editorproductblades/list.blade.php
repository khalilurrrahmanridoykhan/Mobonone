                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <a name="" id="" class="btn btn-success"
                                        href="{{ route('editor.product.create') }}" role="button">Create</a>
                                </div>
                                <div class="col-md-8">
                                                ...
                                                @foreach ($product as $products)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <img src="{{ asset('uploads/product/thumb/small/' . $products->img) }}"
                                                            width="50" alt="">
                                                            @else
                                                        ...
                                                        <td>
                                                            <span>
                                                                <a href="{{ route('editor.product.edit',$products->products_id ) }}"><img
                                                                        src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                        alt=""></a>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            {{-- <a href="{{ route('editor.product.delete', $products->products_id) }}"><img
