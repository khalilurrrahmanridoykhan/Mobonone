                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <a name="" id="" class="btn btn-success"
                                        href="{{ route('admin.brand.create') }}" role="button">Create</a>
                                </div>
                                <div class="col-md-8">
                                        ...
                                        <tbody>
                                            @if (!empty($brand))
                                                @foreach ($brand as $brands)
                                                    <tr>
                                                        <td>{{ $brands->brands_id }}</td>
                                                        <td>
                                                            @if (!empty($brands->img))
                                                            <img src="{{ asset('uploads/brand/thumb/small/' . $brands->img) }}"
                                                            width="50" alt="">
                                                            @else
                                                        ...
                                                        <td>
                                                            <span>
                                                                <a href="{{ route('admin.brand.edit',$brands->brands_id ) }}"><img
                                                                        src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                        alt=""></a>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('admin.brand.delete', $brands->brands_id) }}"><img
