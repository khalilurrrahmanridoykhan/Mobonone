                                    ...
                                    @else
                                        <div class="dropbtn">
                                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#"
                                                ...
                                                {{ Auth::guard('faculty')->user()->name }}
                                                @if (!empty(Auth::guard('faculty')->user()->img))
                                                    <img src="{{ asset('uploads/editor/thumb/small/' . Auth::guard('faculty')->user()->img) }}"
                                                        width="40" alt="" class="rounded-circle">
                                                @else
                                                    <img src="{{ asset('no_image/no_image_small.png') }}" width="40"
                                        ...
                                        <div class="">
                                            ...
                                            <div class="dropdown-content">
                                                <a class="dropdown-item" href="{{ route('faculty.edit') }}"
                                                    >
                                                ...
                                                <form id="logout-form-admin" action="{{ route('faculty.logout') }}"
