        ...
        <div class="row justify-content-center">
            <div class="col-md-11">
                <form action="" method="" name="createassignmentFrom" id="createassignmentFrom">
                    <div class="card">
                        <div class="card-header">{{ __(' Courses Assignment') }}</div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    <br>
                                    <a name="" id="" class="btn btn-primary"
                                        href="{{ route('faculty.assignment.index') }}" role="button">Back</a>
                                </div>
...
@section('extraJs')
    <script type="text/javascript">
        ...
        function checkassignment() {
            ...
            $.ajax({
                type: "get",
                url: "{{ route('faculty.assignment.getsectionfacluty') }}",
                success: function(response) {
                    response.forEach((n) => {
                    ...
                    if (isFund == true) {
                        ...
                        $.ajax({
                            type: "get",
                            url: "{{ route('faculty.assignment.gettimeslotfaculty') }}",
                            success: function(response) {
                            ...
                            success: function(response) {
                                ...
                                if (response.status == 0) {
                                    ...
                                    $("#createassignmentFrom").append(
                                        assingmetnunicehtml);
                                    $.ajax({
                                        url: "{{ route('faculty.assignment.save') }}",
                                        type: 'POST',
                                        dataType: 'json',
                                        data: $(
                                        ...
                                        success: function(
                                            ...
                                            if (response
                                                ...
                                                //     '{{ route('faculty.assignment.index') }}';
                                                ...
                                                $.ajax({
                                                    url: "{{ route('faculty.assignment.savefaculrysection') }}",
                                                    type: 'POST',
                                                    dataType: 'json',
                                                    data: values,
                                                    success: function(
                                                        ...
                                                        if (response
                                                            ...
                                                            // window.location.href = '{{ route('faculty.assignment.index') }}';
                                                ...
                                                $.ajax({
                                                    url: "{{ route('faculty.assignment.savefaculrytimeslot') }}",
                                                    type: 'POST',
                                                    dataType: 'json',
