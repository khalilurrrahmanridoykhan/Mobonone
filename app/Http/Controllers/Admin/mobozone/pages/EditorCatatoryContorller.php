...
class EditorCatatoryContorller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.mobozone.pages.editorcategoryblades.list', $data);
    }

    public function create(){

        return view('admin.mobozone.pages.editorcategoryblades.create');
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('admin.mobozone.pages.editorcategoryblades.edit', $data);
