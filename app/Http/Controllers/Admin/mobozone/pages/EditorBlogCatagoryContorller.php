...
class EditorBlogCatagoryContorller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.mobozone.pages.editorblogcategoryblades.list', $data);
    }
    ...
    public function create(Request $request){
        ...
        return view('admin.mobozone.pages.editorblogcategoryblades.create', $data);
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('admin.mobozone.pages.editorblogcategoryblades.edit', $data);
