...
class AdminBrandController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.mobozone.pages.brandblades.list', $data);
    }
    ...
    public function create(Request $request){
        ...
        return view('admin.mobozone.pages.brandblades.create', $data);
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('admin.mobozone.pages.brandblades.edit', $data);
